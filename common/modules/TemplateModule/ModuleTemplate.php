...
namespace common\modules\TemplateModule;

use Yii;
use common\helpers\StringHelper;

class ModuleTemplate extends \common\base\Module {

	/****
	 ** Note: If exist ConsoleController inside Folder Commands
	 ** to be called, need to add Class Name in
	 ** file [[/console/config/main.php]][[bootstrapForConsole]] on array 'bootstrap'
	 ****/
